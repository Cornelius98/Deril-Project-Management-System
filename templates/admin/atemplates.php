    ...
    public function nav()
    {
        echo '<nav class="navbar navbar-expand-sm navbar-dark">
                <div class="container-fluid">
                    ...
                    <a href="logout" class="sign-out-circle shadow"><i class="fa fa-user-lock"></i></a>
                </div>
            </nav>';
    }
    public function side(){
        echo '<div>
                <div class="user-details">
                    ...
                    <p>
                        <small>Project Creator Account</small> 
                        <br>
                    </p>
                </div>
                <br>
                ...
                if(key_exists("pj_id",$product)){
                    echo '<div class="advertised shadow">
                            ...
                            <div class="advertised-details">
                                <h5>'.$product["name"].'</h5>';
                                echo '<small class="pj-desc">'.date("d F Y",strtotime($product["p_date"])).'</small>';
                            echo '</div>
                            <div class="advertised-menu"> 
                                <div>
                                    <a href="gallery?pipe='.$_SESSION["aSessn"]["aSeck"].'&&pjr='.$product["pj_id"].'&&gallery=1" class="hightlight-attachment">Picures</a>
                                    <a href="gallery?pipe='.$_SESSION["aSessn"]["aSeck"].'&&pjr='.$product["pj_id"].'&&gallery=2" class="hightlight-attachment">PDFs</a>
                                    <a href="gallery?pipe='.$_SESSION["aSessn"]["aSeck"].'&&pjr='.$product["pj_id"].'&&gallery=3" class="hightlight-attachment">Files</a>
                                </div>';
        ...
        $html = '<div style="color:#0000;background-color:white;font-family:arial;">
                <div style="color:#0000">
                    <div style="color:#0000;border-bottom:1px solid rgb(67,103,132);line-height:14px;">
                        <br/>
                        <small style="color:#0000;text-align:right;font-size:25px;text-transform:uppercase;"><b>Project Report</b></small>
                        <br/>
                        <br/>
                    ...
                    <div>
                        <div style="color:#0000;line-height:14px;margin-right:0;">
                            <small>
                                <strong>
                                <br/>
                                    <span style="color:#0000;">ICU</span><span style="color:#0000;">ZAMBIA</span>
                                </strong>
                            </small><br/>
    ...
    private function vw_discussion_even($discussion){
        echo '<div class="even-discuss">
                ...
                <div class="contributor-timestamp">
                    '.date("H:i A", strtotime($discussion["dsc_time"])).'
                </div>
            </div>';
    }
        ...
        if(is_array($productsContainer) && !empty($productsContainer)){
            foreach($productsContainer As $share){
                echo '<tr>
                    ...
                    <td  class="ads-prop-value"><a onclick="unicastPlatformShare('.$_SESSION["aSessn"]["aSeck"].','.$share["shc_id"].','.$pj_id.');" target="_blank" href="'.$share["official_link"].'" ><i class="fa fa-arrow-right"><i/></td>
                </tr>';
            }
        }else {
            echo '<h5 class="err_products">
