        ...
        <main class="signup-main">
            <div class="container">
                <div class="row justify-content-space-between tabs">
                    <div class="GospelText col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-3 my-*-0 logs-border">
                        <h4>Project Manager.</h4>
                        <p>
                           Project Managers, Allows You To;<br> 
                    ...
                    <div class="col-xs-12 col-sm-12 col-md-6 col-lg-6 col-xl-6 my-3 my-*-0 form-center">
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-fader">
                                    ...
                                    <div class="row">
                                        <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12 col-xl-12">
                                            <div id="pass-eye" class="pass-eye">
                                                <h6 class="inner-header">Should Contain Atleast Five(5) Characters</h6>
                                                <input type="password" 
                                                        id="secretCode"
                        ...
                        <div class="modal-footer">
                            <button type="button" class="btn btn-dark" data-dismiss="modal">Close</button>                </div>
                        </div>
                    </div>
                </div>
            </div>
