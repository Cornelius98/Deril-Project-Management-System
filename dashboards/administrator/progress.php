...
<body>
                ...
                <div id="post-wrapper-fader">
                    <div class="row">
                        ...
                        <section class="col-sm-12 col-md-9 col-lg-9 col-xl-9 section">
                            ...
                            <hr>
                            <a href="invite?<?php echo $params;?>" class="btn btn-dark btn-sm">Invite Team</a>
                            <a href="share?<?php echo $params;?>" class="btn btn-dark btn-sm">Share With Team</a>
                            <a href="discuss?<?php echo $params;?>" class="btn btn-dark btn-sm">Discussion Room</a>
                            ...
                            <div class="form-wrap">
                                ...
                                <form>
                                    ...
                                    <div class="form-grouped">
                                        <h5>RECORD CONTINUED PROGRESS</h5><hr>
                                        ...
                                        <div class="form-group-even">
                                            ...
                                            <input type="text" name="tname" id="tname" placeholder="Alternative Name" />
                                            <input type="text" name="desc" id="desc" placeholder="Short Description"/>
                                            <input type="text" name="summary" id="summary" placeholder="Expectation"/>
                                        ...
                                        <div>
                                            <button type="button" 
                                                    class="btn btn-dark 
                                                            ...
                                                            form-control"
                                                    id="migrateAdd">
                                                    <strong>RECORD PROJECT PROGRESS</strong> 
                                            </button>
                                        </div>
                                    </div>
                                </form>
    ...
    <script>
        var barTaggs = ["Photos", "PDFs", "Files"];
