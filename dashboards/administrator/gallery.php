...
<html>
<head>
    <?php $AdminiUXTemplate->headers('Project Files');?>
</head>
<body>
                ...
                <div id="post-wrapper-fader">
                    <div class="row">
                        ...
                        <section class="col-sm-12 col-md-9 col-lg-9 col-xl-9 section">
                            ...
                            <h5><?php echo $Utility->gallery_name($gallery_type); ?> Gallery (<?php echo is_array($projectContainer)?sizeof($projectContainer):0;?>)</h5>
                            <hr>
